  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        warmup: {
          500: 'rgb(var(--color-warmup-500-rgb) / <alpha-value>)',
          600: 'var(--color-warmup-600)',
          700: 'var(--color-warmup-700)',
        },
        skill: {
          500: 'rgb(var(--color-skill-500-rgb) / <alpha-value>)',
          600: 'var(--color-skill-600)',
          700: 'var(--color-skill-700)',
        },
        main: {
          500: 'rgb(var(--color-main-500-rgb) / <alpha-value>)',
          600: 'var(--color-main-600)',
          700: 'var(--color-main-700)',
        },
        accessory: {
          500: 'rgb(var(--color-accessory-500-rgb) / <alpha-value>)',
        ...
        cooldown: {
          500: 'rgb(var(--color-cooldown-500-rgb) / <alpha-value>)',
