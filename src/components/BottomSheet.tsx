    ...
    return (
        ...
        >
            ...
            <div
                ...
                tabIndex={-1}
                className={`relative w-full max-w-lg bg-sys-surface rounded-t-[28px] flex flex-col overflow-hidden animate-slide-up surface-elevation-3 ${className}`}
                style={sheetStyle}
            ...
            >
                ...
                {showHandle && (
                    ...
                    >
                        ...
                        <div className="w-8 h-1 rounded-full bg-sys-onSurfaceVar/40" />
                    </div>
                )}
